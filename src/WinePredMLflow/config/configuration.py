...
from src.WinePredMLflow.entity.config_entity import ModelEvaluationConfig,ModelTrainerConfig,DataTransformationConfig,DataIngestionConfig,DataValidationConfig
